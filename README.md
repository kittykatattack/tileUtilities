...
[Hexi game engine](https://github.com/kittykatattack/hexi) here (click
the image links below to play the examples - use the arrow keys to
...
use the `worldCamera` method from the [Game Utilities]() library.
...
the original array. This can possibly help prevent some weird bugs in a complex game. Immutability rules!
...
```
This will give you a new array called `items` that contains sprites
...
For working example of `hitTestTile`, and how to resolve collisions, [see this example](https://cdn.gitcdn.xyz/cdn/kittykatattack/hexi/212cbbc1a543229ce19bae6649a2970bf1a206d9/examples/36_tiledEditorSupport.html) from
the [Hexi game engine](https://github.com/kittykatattack/hexi).
...
`world` object that represents you game world.
```js
